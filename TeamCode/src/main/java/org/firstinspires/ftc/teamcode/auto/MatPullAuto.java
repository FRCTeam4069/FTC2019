...
import org.firstinspires.ftc.teamcode.commands.Delay;
...
public class MatPullAuto extends OpMode {
    ...
    public void init() {
        ...
        DropdownOn raiseDropdown = new DropdownOn(-0.7);
        GoForwards goForwards = new GoForwards(0.75, 1200);
        //ParallelCommand parallelCommand1 = new ParallelCommand(raiseDropdown, goForwards, false);
        DropdownOn lowerDropdown = new DropdownOn(0.5);
        DropdownOn holdDropdown = new DropdownOn(0.5);
        GoForwards goBackwards = new GoForwards(-0.75, 1200);
